//using jQuery and ajax to send/use post request
$('.form').submit(function (event) {
    ...
    $.ajax({
        url: 'https://gleeful-moxie-4bb6e3.netlify.app/tweet',
        method: 'POST',
        ...
        success: function (data) {
            ...
            `;
            //this will make the tweet appear on the top
            container.insertAdjacentElement('afterbegin', article);

            //clears the input once the tweet is submitted
